...
本项目采用[FastAPI](https://github.com/tiangolo/fastapi) + [APSchdeuler](https://github.com/topics/apscheduler) + [ZeroRPC](https://github.com/0rpc/zerorpc-python)开发轻量级定时调度平台
